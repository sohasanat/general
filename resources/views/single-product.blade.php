    ...
    <section class="px-4 mb-24">
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="flex flex-col items-center justify-center relative mb-8 mt-16">
                <h2 class="font-YekanBakh-ExtraBlack text-3xl">شارژ بهینه ذوب</h2>
            ...
            <div class="max-w-4xl mx-auto">
                  <div class="mb-12">
                  <div class="">
                                <img class="rounded-xl cursor-pointer" src="../assets/images/slider-1.jpg" />
                              </div>
...
<ul>
  ...
  <li>
- انتخاب بهینه مواد اولیه جهت استخراج ذوب مورد نظر
  </li>
  <li>
  - بهینه سازی بر اساس ضریب اهمیت و دسترسی مواد و قیمت
</li>
<li>
- امکان استفاده از بلوکه ها در مواد اولیه
</li>
<li>
- امکان تعریف پاشنه (پایه) ذوب
</li>
<li>
- امکان معرفی کوره ها
</li>
<li>
- به روزرسانی موجودی مواد اولیه از انبار
</li>
<li>
- به روز رسانی قیمت مواد اولیه از فهرست بها
                      ...
                      <div class="  rounded-lg">
                        ...
                        <div class="grid gap-4">
                            ...
                            <div class="bg-orange-200 rounded-lg flex items-center">
                              <div class="bg-stone-900 text-white rounded-lg p-2 icongreen">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                </svg>
                                               
                              </div>
                              <div class="mr-2">پیش نیازها: 
                              نگارش راهکاران ۱۴ - 
مولفه ها تولید، انبار، تدارکات</div>
                            </div>
                            <div class="bg-orange-200 rounded-lg flex items-center">
                              <div class="bg-stone-900 text-white rounded-lg p-2 icongreen">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  ...
                  <div class="mb-12">
                    ...
                    <div class="swiper sin-project">
                        ...
                        <div class="swiper-slide">
                          ...
                          <a href="/single-product" class="bg-white w-full displayflex p-6 rounded-3xl leading-8 transform hover:-translate-y-1 duration-300 transition-transform">
                    <div class="w-10 mb-4">
