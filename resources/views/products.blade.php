...
<ul class="leading-10">
        <li>
            <input type="checkbox" name="categories" class="formInput ml-4" value="Kotlin" id="cat-35">
          <label for="cat-35"> انبار و تدارکات </label>
        </li>
        
        <li>
            
            <input type="checkbox" name="categories" class="formInput ml-4" value="Ionic" id="cat-38">
             <label for="cat-38"> پخش </label>
            
            </li>
            <li>
                <input type="checkbox" name="categories" class="formInput ml-4" value="Android" id="cat-40">
                 <label for="cat-40"> خرده فروشی </label>
                </li>
                <li>
                    <input type="checkbox" name="categories" class="formInput ml-4" value="Cordova" id="cat-44">
                     <label for="cat-44"> سرمایه انسانی </label>
                    </li>
                    <li>
                        <input type="checkbox" name="categories" class="formInput ml-4" value="PWA" id="cat-52">
                         <label for="cat-52"> عمومی و زیرساخت </label>
                        </li>
                        <li>
                            <input type="checkbox" name="categories" class="formInput ml-4" value="Dart" id="cat-66">
                             <label for="cat-66"> فروش و خدمات </label>
                            </li>
                            <li>
                                <input type="checkbox" name="categories" class="formInput ml-4" value="Flutter" id="cat-67">
                                 <label for="cat-67"> مالی و حسابداری </label>
                                </li>
                                <li>
                                    <input type="checkbox" name="categories" class="formInput ml-4" value="MAUI" id="cat-2099">
                                     <label for="cat-2099"> مدیریت پروژه </label>
                                    
                                    </li>
                                    <li>
                                        <input type="checkbox" name="categories" class="formInput ml-4" value="Swift" id="cat-2100">
