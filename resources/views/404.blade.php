...
<head>
    ...
    <title>404</title><link rel="icon" type="image/x-icon" href="../assets/images/favicon.ico">
</head>
            ...
            <div class="drawer">
                ...
                <div class="drawer-side">
                  ...
                  <ul class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                    ...
                    <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="products.html">خدمات</a></li>
                    <li><details>
