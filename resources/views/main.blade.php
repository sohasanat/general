            ...
            <div class="mx-auto px-4 lg:px-0 max-w-md sm:max-w-3xl lg:max-w-7xl">
                <div class="relative rounded-3xl px-6 py-10 bg-stone-800 overflow-hidden shadow-xl sm:px-12 sm:py-16">
                    ...
                    <div class="relative flex flex-col">
                        ...
                        <a href="{{ route('connect.us') }}" class="w-auto inline-block mt-5 mx-auto py-2 px-7 rounded-full bg-orange-200 hover:duration-300 font-YekanBakh-SemiBold text-white">تماس بگیرید</a>
                    </div>
                </div>
            </div>
        </div>
