  ...
  <section class="px-4 mb-24 min-height-50">
    <div class="container mx-auto max-w-screen-xl">
      ...
      <div class="lightGreen2 mt-16 p-6 rounded-lg ">
        <form action="<?php echo e(route('customer.editsave', $editcustomer->id)); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="text-base text-gray-700 sm:text-lg leading-8 flex flex-col gap-6">
            <input required type="text" value="<?php echo e($editcustomer->name); ?>" name="name" placeholder="نام مشتری" class="input w-full  focus:outline-none placeholder:text-sm" />
...
</html><?php /**PATH C:\Users\danesh\laravelprojectone\resources\views/c-customerEdit.blade.php ENDPATH**/ ?>