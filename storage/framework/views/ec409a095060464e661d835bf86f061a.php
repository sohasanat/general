  ...
  <section class="px-4 mb-24 min-height-50">
    <div class="container mx-auto max-w-screen-xl">
      ...
      <div class="lightGreen2 mt-16 p-6 rounded-lg ">
        <form action="<?php echo e(route('cmsjob.editsave',$editjob->id)); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="text-base text-gray-700 sm:text-lg leading-8 flex flex-col gap-6">
            <input required name="title" value="<?php echo e($editjob->title); ?>" type="text" placeholder="نام شغل" class="input w-full  focus:outline-none placeholder:text-sm" />
            <input required name="Description" value="<?php echo e($editjob->Description); ?>" type="text" placeholder=" نوع همکاری" class="input w-full  focus:outline-none placeholder:text-sm" />
            <div class="flex flex-col gap-2 text-sm">
              ...
              <ul id="myULExpertise" class="flex gap-4 dir-l flex-wrap">
                <?php $__currentLoopData = $experiense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ex): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li onclick="deleteFunction(this, 'Expertise')" class="cli" id="see"><span><?php echo e($ex->expertiseDescription); ?></span><span class="closel">×</span></li>
            ...
            <div class="flex flex-col gap-2 text-sm">
              ...
              <ul id="myULSkill" class="flex gap-4 dir-l flex-wrap">
                ...
                <li onclick="deleteFunction(this, 'Skill')" class="cli"><span><?php echo e($skill->skillsDescription); ?></span><span class="closel">×</span></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
...
</html><?php /**PATH D:\websiteSohaSanat\general\resources\views/c-jobEdit.blade.php ENDPATH**/ ?>