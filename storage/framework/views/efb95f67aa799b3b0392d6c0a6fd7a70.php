...
<body class="font-YekanBakh-Regular text-sm bg-gradient-to-t">
  ...
  <div class="bg-white rounded-lg flex flex-col  items-center justify-between border-1p px-6 pt-5 mt-5">

  <div class="justify-center flex sm:justify-between gap-x-2 items-center w-full flex-wrap  ">
             <span class="mt-3">نام کاربر فرستنده پیام
               
             </span>
             <div class="flex items-center justify-center rounded-full btnBorder hover:duration-300 font-YekanBakh-SemiBold color-green w-36 text-center h-8 mt-3">
                <a href="c-ticketListHistory" class=" rounded-full font-YekanBakh-Regular">لیست پیام های قبلی</a>
            </div>
</div>
...
</p>        <div class="flex justify-end  mt-2">
20:21
        </div> 
      </div>
...
</html><?php /**PATH D:\websiteSohaSanat\general\resources\views/ticketing/c-ticketDetail.blade.php ENDPATH**/ ?>