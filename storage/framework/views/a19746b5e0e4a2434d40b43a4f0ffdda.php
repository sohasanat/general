<section class="px-4 static lightGreen2 text-gray">
            ...
            <div class="flex justify-between items-center py-6">
                    ...
                    <div class="drawer">
                        ...
                        <div class="drawer-side">
                            ...
                            <ul class="menu p-4 w-80 min-h-full lightGreen2 text-base-content text-gray font-YekanBakh-SemiBold">
                                ...
                                <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="product-list">مدیریت محصولات</a></li>
                                <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="<?php echo e(route('blog.list')); ?>">مدیریت وبلاگ‌ها</a></li>
                                <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="job-list">مدیریت فرصت‌های شغلی</a></li>
                ...
                <div class="hidden lg:block">
                    <ul class="flex menu lg:menu-horizontal text-gray font-YekanBakh-SemiBold ">
                        <li><a class="hover:border-b hover:border-orange-200 pb-1 border-black duration-300" href="product-list">مدیریت محصولات</a></li>
                        ...
                        <li><a class="hover:border-b hover:border-orange-200 pb-1 border-black duration-300" href="job-list">مدیریت فرصت‌های شغلی</a></li>
    ...
    </section><?php /**PATH D:\websiteSohaSanat\general\resources\views/c-header.blade.php ENDPATH**/ ?>