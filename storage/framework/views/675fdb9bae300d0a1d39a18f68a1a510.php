                            ...
                            <div class="lv ts arv avo cfc ddh">
                                <table class="ts acc ach">
                                    ...
                                    <tbody class="acc acg">
                                        ...
                                        <?php $__currentLoopData = $alljobsvar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="bgm tablesRow">
                                            <td class="adm asc atn auc awa awe axv cgi">1</td>
                                            <td class="adm arf asc awa axr"><?php echo e($job->name); ?></td>
                                            <td class="adm arf asc awa axr"><?php echo e($job->jobname); ?></td>
                                            <td class="adm arf asc awa axr"><?php echo e($job->phone); ?></td>
                                            <td class="adm arf asc awa axr"><?php echo e($job->email); ?></td>
                                            <td id="dataTime" class="adm arf asc awa axr"><?php echo e($job->date); ?></td>
                                            <td class="ab arf adm asc atm aue avm awa awe cgp">
                                                <a href="<?php echo e(route('resume.details', $job->resume)); ?>" class="ayh bli">مشاهده رزومه</a>
                                            </td>
                                        </tr>
...
</html><?php /**PATH C:\Users\danesh\laravelprojectone\resources\views/c-resumeList.blade.php ENDPATH**/ ?>