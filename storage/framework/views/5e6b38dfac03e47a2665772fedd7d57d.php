        ...
        <div class="alo arr">
            <div class="gx ua wrapperTable">
                <div class="ari cfc ddh">
                    <div class="bxr cbi">
                        <div class="bzy">
                            <h1 class="avy awg awp axv">لیست مشتریان</h1>
                        </div>
                        <div class="lh bwf bwv bzz">
                            <a href="/customer-create">
                                <button type="button" class="lu adu ajr arf arv avl awa awg bah bbn bis boy boz bpb bpk">ایجاد مشتری<button></a>
                                ...
                                <table class="ts acc ach">
                                    <thead>
                                        <tr class="bgm">
                                            ...
                                            <th scope="col" class="arf asa avk awa awg axv">لوگوی مشتری</th>
                                            <th scope="col" class="asa atn auc avk awa awg axv cgi">نام مشتری</th>
...
</html><?php /**PATH C:\Users\danesh\laravelprojectone\resources\views/c-customerList.blade.php ENDPATH**/ ?>