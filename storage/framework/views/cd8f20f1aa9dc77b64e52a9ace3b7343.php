                        ...
                        <div class="gc gl adi buw cte">
                            <div class="lv ts arv avo cfc ddh">
                                <table class="ts acc ach">
                                    ...
                                    <tbody class="acc acg">
                                        <?php $__currentLoopData = $productsvar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="bgm tablesRow">
                                            <td class="adm asc atn auc awa awe axv cgi">1</td>
                                            <td class="adm arf asc awa axr"><img class="imgB" src="<?php echo e($product->logo); ?>" alt=""></td>
                                            <td class="adm arf asc awa axr"><?php echo e($product->name); ?></td>
                                            <td class="ab arf adm asc atm aue avm awa awe cgp">
                                                <a href="<?php echo e(route('product.editview',$product->id)); ?>" method="POST" class="ayh bli edit">ویرایش</a>
                                                <a href="<?php echo e(route('product.delete',$product->id)); ?>" method="POST" class="ayh bli">حذف</a>
                                            </td>
                                        </tr>
