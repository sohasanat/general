...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('public'); ?>
        ...
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white displayflex p-6 rounded-3xl leading-8 transform hover:-translate-y-1 duration-300 transition-transform">
                    <div class="w-10 mb-4">
                        <img src="<?php echo e($company->Description); ?>" alt="">
                    </div>
            ...
            <div class="mx-auto px-4 lg:px-0 max-w-md sm:max-w-3xl lg:max-w-7xl">
                <div class="relative rounded-3xl px-6 py-10 bg-stone-800 overflow-hidden shadow-xl sm:px-12 sm:py-16">
                    ...
                    <div class="relative flex flex-col">
                        ...
                        <a href="<?php echo e(route('connect.us')); ?>" class="w-auto inline-block mt-5 mx-auto py-2 px-7 rounded-full bg-orange-200 hover:duration-300 font-YekanBakh-SemiBold">تماس بگیرید</a>
                    </div>
                </div>
            </div>
        </div>
