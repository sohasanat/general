          ...
          <div thumbsSlider="" class="swiper gall-project mt-4">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide  overflow-y-h h-36">
                <img class="rounded-xl cursor-pointer min-height-9 images" src="<?php echo e($img->image); ?>" />
              </div>
                ...
                ?>
                  <div class="swiper-slide">
                    <div class="group/item">
                      <a href="<?php echo e(route('product.details', $relproduts->id)); ?>" class="bg-white w-full displayflex p-6 rounded-3xl leading-8 transform hover:-translate-y-1 duration-300 transition-transform">
                        <div class="w-10 mb-4">
