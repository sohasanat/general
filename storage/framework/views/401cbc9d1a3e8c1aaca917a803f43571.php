      ...
      <div class="bg-white rounded-lg flex flex-col  items-center justify-between border-1p px-6 mt-5">
        ...
        <div class="w-full text-center my-6">
          ...
          <div class="border btn-w bg-orange-200 text-white hover:text-white hover:bg-green duration-300 rounded-lg text-center">
            <a href="<?php echo e(route('history.tiket',$tiket->idtiket)); ?>" class="rounded-lg font-YekanBakh-Regular text-center  py-2.5 w-full">تاریخچه ی کاربر</a>
        ...
        <form class="w-full" action="<?php echo e(route('cmsmessege.save')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
            ...
            <div class="flex justify-between items-center flex-wrap w-full mt-4 gap-x-2 leading-10">
              ...
              <div class="justify-center flex sm:justify-between gap-x-2 flex-wrap w-full gap-y-5">
                <div class="flex-1 w-300 flex">
                  ...
                  <input name="from" type="text" value="<?php echo e($username->id); ?>" class="hidden">
                  <input name="tiket_id" type="text" value="<?php echo e($tiket->id); ?>" class="hidden">
...
</html><?php /**PATH C:\Users\danesh\laravelprojectone\resources\views/ticketing/c-ticketDetail.blade.php ENDPATH**/ ?>