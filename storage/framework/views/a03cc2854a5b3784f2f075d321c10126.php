            ...
            <div class="flex justify-between items-center py-6">
                    ...
                    <div class="drawer">
                        ...
                        <div class="drawer-side">
                            ...
                            <ul class="menu p-4 w-80 min-h-full lightGreen2 text-base-content text-gray font-YekanBakh-SemiBold">
                                ...
                                <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="<?php echo e(route('login.view')); ?>"> مشاهده حساب کاربری</a></li>
                                <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="<?php echo e(route('login.view')); ?>"> تیکت ها</a></li>
                                <li><a class="hover:border-b hover:border-orange-200 pb-1 duration-300" href="<?php echo e(route('login.view')); ?>"> خروج از حساب</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden lg:block">
                    <ul class="flex menu lg:menu-horizontal text-gray font-YekanBakh-SemiBold ">
                        ...
                        <?php if(session('role') == $role): ?>

                        <li><a class="hover:border-b hover:border-orange-200 pb-1 border-black duration-300" href="<?php echo e(route('main.prof')); ?>">صفحه اصلی</a></li>
                        <?php else: ?>
                ...
                <li><?php if(isset($username->name)): ?>
                    <?php else: ?>
                    <div class="border bg-green text-white hover:text-white hover:bg-green duration-300 rounded-full hidden sm:block">
                        <a href="<?php echo e(route('login.view')); ?>" class="flex py-2.5 px-7 rounded-full font-YekanBakh-Regular">ورود | ثبت نام</a>
                    </div>
                    <?php endif; ?>
                    <ul class=" menu lg:menu-horizontal text-gray font-YekanBakh-SemiBold hidden sm:flex">
                        <li><?php if(isset($username->name)): ?>
                            ...
                            <details>
                                <summary><a>نام کاربری طرف <?php echo e($username->name); ?></a></summary>
                                <ul class="p-2 z-10 w-48 bg-[#f5f1e4] m-0 top-left">
                                    <li><a href="/blog-2.html">مشاهده حساب کاربری</a></li>
                                    <li><a href="<?php echo e(route('tiket.view')); ?>">تیکت ها</a></li>
                                    <li><a href="<?php echo e(route('user.logout')); ?>">خروج از حساب</a></li>
                                </ul>
                            </details>
                            <!-- <summary><a>نام کاربری طرف <?php echo e($username->name); ?></a></summary> -->
                            <?php endif; ?>
    ...
    </section><?php /**PATH D:\websiteSohaSanat\general\resources\views/header.blade.php ENDPATH**/ ?>