    ...
    <section class="px-4 mb-24">
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="flex flex-col items-center justify-center relative my-16">
                <h2 class="font-YekanBakh-ExtraBlack text-3xl"><?php echo e($blog->title); ?></h2>

                <div class="bg-orange-200 w-20 h-1.5 rounded-full absolute top-10"></div>
                <p class="mt-4"><?php echo e($blog->point); ?></p>
            </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12">
                    ...
                    <?php $__currentLoopData = $blogvar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <?php if($blogvar->id = $blog->id): ?>
                    <div class="mr-2">
                        <a href="<?php echo e(route('blog.single', $blog1->id)); ?>">
                            <h2 class="font-YekanBakh-ExtraBold text-base"><?php echo e($blog1->title); ?></h2>
                        </a>
                        <p class="mt-2"><?php echo e($blog1->point); ?></p>
                    </div>
...
</html><?php /**PATH C:\Users\danesh\laravelprojectone\resources\views/single-page.blade.php ENDPATH**/ ?>